<div>
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6">
        ...
        <x-card class="neo-stat neo-stat--peach px-6 py-4 col-span-1 lg:col-span-2">
        ...
        <x-card class="neo-stat neo-stat--white px-6 py-4">
        ...
        <x-card class="neo-stat neo-stat--blue px-6 py-4">
