<main x-data="{ id: 0 }" class="flex-1 lg:flex">
    ...
    <div class="w-full lg:w-1/3 bg-white dark:bg-gray-900 flex flex-col">
        ...
        @else
            <div class="grow flex justify-center items-center h-40 text-gray-400 dark:text-gray-500">
                @if ($initial)
                    <span class="text-2xl">{{ __("Empty Inbox") }}</span>
                @else
                    {{-- FastOTP: small subtle loader, not a big blocking animation --}}
