...
@php
    $baseClasses = "neo-btn inline-flex items-center px-4 py-2 font-bold uppercase tracking-wide focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150";
